...
export default function MySongs() {
  ...
  return (
    <section
      id="songs"
      className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-[#0e001a] via-[#1a0033] to-[#3b007d] text-white px-6 py-24 font-medium"
    >
...
function VideoCard({ video }) {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="relative aspect-video rounded-xl overflow-hidden shadow-lg bg-black/40"
    >
      {isPlaying ? (
        <iframe
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center shadow-10xl bg-black/40 backdrop-blur-sm transition group-hover:bg-black/20">
            <svg
